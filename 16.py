...
# ========只能识别单行的. 先不用.
        ...
        for  jj in result:
            ...
            tupiangaodu=out_for_fullname[0][2][1]-out_for_fullname[0][0][1]

            bili=0.02
            d=[out_for_fullname[0][0][0],out_for_fullname[0][0][1]-tupiangaodu*bili,out_for_fullname[0][2][0],out_for_fullname[0][2][1]+tupiangaodu*bili]
            print('切割点',d)
            imgs.append(image.crop(d))
    ...
    if 1:
            ...
            if  out_for_fullname:
                ...
                out3=out2.values
                out3=[]
                for i in ['SERIALNUMBER','SERIALNUMBER:','IDNUMBER','IDNUMBER:','ID NUMBER','ID NUMBER:','FULLNAMES','FULL NAMES','DATE OF BIRTH','DATEOFBIRTH','DATE OFBIRTH','DATEOF BIRTH','SEX','DISTRICTOFBIRTH','DISTRICT OFBIRTH','DISTRICTORBIRTH', 'PLACEOFISSUE','PLACE OF ISSUE','PLACEOF ISSUE','PLACE OFISSUE','DATE OFISSUE','DATEOFISSUE','DATE OF ISSUE',]:# 注意顺序.
                    if i in out2:
                        out3.append(out2[i])
                print('人名修复后',out3)
                out=out3
