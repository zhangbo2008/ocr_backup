...
remember={}
other={}
dic=['SERIALNUMBER','IDNUMBER','FULLNAMES','DATE OF BIRTH','SEX','DISTRICTORBIRTH','DISTRICTOFBIRTH', 'PLACEOFISSUE','DATE OFISSUE','PLACE OF ISSUE','PLACEOF ISSUE','PLACE OFISSUE','DATEOFISSUE','DATE OF ISSUE','PLACEOFISSUE','DISTRICTORBIRTH','SERIALNUMBER:','IDNUMBER:','DATEOFBIRTH','DATEOF BIRTH','DATE OFBIRTH','FULL NAMES','ID NUMBER','DISTRICT OFBIRTH']
for i in result:
 for j in dic:
